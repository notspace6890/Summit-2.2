...
public class WaypointCommand extends Command
{
    ...
    public void processCommand(final String input, final String[] args) {
        ...
        if (pos == null) {
            pos = new SalVec3d(this.mc.field_71439_g.field_70165_t, this.mc.field_71439_g.field_70163_u, this.mc.field_71439_g.field_70161_v);
        }
        if (args[1].startsWith("a")) {
            ...
            WaypointManager.Get().AddWaypoint(Waypoint.Type.Normal, name, pos, this.mc.field_71439_g.field_71093_bK);
        }
